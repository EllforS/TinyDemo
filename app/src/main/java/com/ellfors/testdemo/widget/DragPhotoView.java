...
public class DragPhotoView extends PhotoView
{
        ...
        if (getScale() == 1)
        {
            switch (event.getAction())
            {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (Math.abs(mTranslateY) >= Math.abs(mTranslateX) && event.getPointerCount() == 1)
                    {
                        onActionMove(event);
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    postDelayed(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            if (mTranslateX == 0 && mTranslateY == 0 && canFinish && mTapListener != null)
    ...
    {
        if (mTranslateY > MAX_TRANSLATE_Y && mExitListener != null)
