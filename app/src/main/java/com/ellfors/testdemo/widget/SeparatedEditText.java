...
{
    private static final int TYPE_HOLLOW = 1;       //空心无间距
    private static final int TYPE_SOLID = 2;        //实心
    private static final int TYPE_UNDERLINE = 3;    //下划线
    private static final int TYPE_STROKE = 4;       //空心

    private static final int DEFAULT_COLOR = 0XFFD3D3D3;
    ...
    public SeparatedEditText(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        borderColor = ta.getColor(R.styleable.SeparatedEditText_borderColor, DEFAULT_COLOR);
        blockColor = ta.getColor(R.styleable.SeparatedEditText_blockColor, DEFAULT_COLOR);
        textColor = ta.getColor(R.styleable.SeparatedEditText_textColor, DEFAULT_COLOR);
        cursorColor = ta.getColor(R.styleable.SeparatedEditText_cursorColor, DEFAULT_COLOR);
